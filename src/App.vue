...
<div class="container-fluid">
    <div class="px-lg-2 px-sm-2 pb-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-12 d-flex justify-content-center" :style="{ backgroundColor: BackgroundColor }">
                <!--2nd box-->
                <!-- shirt column -->
                <div class="wrap-image">
                  
                    <img src="./assets/blouse-women-rsquo-s-fashion.png" alt="with background">
                </div>
            </div>
            <thirdColumn />
        </div>
